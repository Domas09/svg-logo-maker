...
describe('Circle', () => {
    ...
    describe('Render Function', () => {
        it('should return all properties properly formatted for svg file', ()=> {
            ...
            circle.setText('drg');
            circle.setColor('red');
            expect(circle.render()).toEqual(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"></svg>
...
describe('Triangle', () => {
    ...
    describe('Render Function', () => {
        it('should return all properties properly formatted for svg file', ()=> {
            ...
            expect(triangle.render()).toEqual(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"></svg>
...
describe('Square', () => {
    ...
    describe('Render Function', () => {
        it('should return all properties properly formatted for svg file', ()=> {
            ...
            square.setText('drg');
            square.setColor('red');
            expect(square.render()).toEqual(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"></svg>
